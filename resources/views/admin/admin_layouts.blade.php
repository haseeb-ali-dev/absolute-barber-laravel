...
<div id="wrapper">
    ...
    <!-- Sidebar -->
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion @if(session('is_super') == 0) d-none @endif" id="accordionSidebar">
        ...
        <li class="nav-item @if($conName[1] == 'tools') active @endif">
            <a class="nav-link" href="{{ route('admin.tools') }}">
                <i class="fas fa-fw fa-home"></i>
                <span>Bercodetech Tools</span>
        ...
        <li class="nav-item @if($conName[1] == 'product' || $conName[1] == 'shipping' || $conName[1] == 'coupon') active @endif">
            ...
            <div id="collapseProduct" class="collapse @if($conName[1] == 'product' || $conName[1] == 'shipping' || $conName[1] == 'coupon' || $conName[1] == 'product_category') show @endif" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                <div class="bg-white py-2 collapse-inner rounded">
                    ...
                    <a class="collapse-item" href="{{ route('admin.product_category.index') }}">Product Categories</a>
        ...
        @endif
         ...
         <!--<li class="nav-item @if($conName[1] == 'import_excel_contacts') active @endif">-->
         <!--    <a class="nav-link" href="{{ route('admin.excel.import') }}">-->
         <!--        <i class="fas fa-users"></i>-->
         ...
         <!--@endif-->
          <!-- Excel Contacts -->
          @php if(session('role_id')==1 ): @endphp
          <li class="nav-item @if($conName[1] == 'admin_manual_messages') active @endif">
              <a class="nav-link" href="{{ route('admin.manual.messages') }}">
                  <i class="fas fa-users"></i>
                  <span>Manual Messages/Email</span>
              </a>
          </li>
          @endif
          ...
          <!--@php if(session('role_id')==1 ): @endphp-->
          <!--<li class="nav-item @if($conName[1] == 'landing_page_contact') active @endif">-->
          <!--    <a class="nav-link" href="{{ route('admin.landing_page_contact_setting') }}">-->
          <!--        <i class="fas fa-users"></i>-->
          ...
          <!--@php if(session('role_id')==1 ): @endphp-->
          <!--<li class="nav-item @if($conName[1] == 'landing_page_messages') active @endif">-->
          <!--    <a class="nav-link" href="{{ route('admin.landing_page_messages') }}">-->
          <!--        <i class="fas fa-users"></i>-->
          <!--        <span>Landing Page Contacts</span>-->
          <!--    </a>-->
          <!--</li>-->
          <!--@endif-->

          {{-- @php if(session('role_id')==1 ): @endphp
          <li class="nav-item @if($conName[1] == 'compose_document') active @endif">
              <a class="nav-link" href="{{ route('admin.compose_document') }}">
                  <i class="fas fa-users"></i>
        ...
        <!-- Draw -->
        {{-- @php if( session('role_id')==1 ): @endphp
        <li class="nav-item @if($conName[1] == 'signature-pad') active @endif">
            <a class="nav-link" href="{{ route('signature-pad.draw') }}">
        ...
        <li class="nav-item @if($conName[1] == 'messages') active @endif">
        ...
        <!--<li class="nav-item @if($conName[1] == 'order_shipping') active @endif">-->
        <!--    <a class="nav-link" href="{{ route('order_shipping.index') }}">-->
        <!--        <i class="fab fa-facebook-messenger"></i>-->
        <!--        <span>shippings</span>-->
        <!--    </a>-->
        <!--</li>-->
